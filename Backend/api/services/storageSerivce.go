...
func ConnectS3() error {
	...
	StorageSession, err = session.NewSession(&aws.Config{
		Credentials: credentials.NewStaticCredentials(configs.Config.StorageServiceID, configs.Config.StorageServiceSecret, ""),
		Region:      aws.String("default"),
		Endpoint:    aws.String(configs.Config.StorageServiceEndpoint),
	})
